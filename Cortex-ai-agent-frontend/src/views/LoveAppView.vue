...
async function loadDashboard() {
  ...
  if (routingPolicyDriftResult.status === 'fulfilled') {
    routingPolicyDrift.value = routingPolicyDriftResult.value
  }
  if (routingPolicyProgressiveDeliveryResult.status === 'fulfilled') {
