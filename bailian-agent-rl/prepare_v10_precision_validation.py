#!/usr/bin/env python3
"""Freeze the one-shot v10 precision validation without model calls."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        / "precision-validation/v10-config.json",
    )
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({
            "state": "V10_PRECISION_VALIDATION_FROZEN",
        ...
        print(f"V10 precision validation freeze failed: {error}", file=sys.stderr)
        return 2
